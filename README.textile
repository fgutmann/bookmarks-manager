...
* Download the jar file from here: https://github.com/downloads/fgutmann/bookmarks-manager/delicious2firefox.jar
...
** For windows users: Enter "cd <path to folders>" into the command promt and hit return
